namespace BEL.MaterialTrackingWorkflow.Models.InwardRequest
{
    ...
    public class InwardRequestForm : IForm
    {
                /// <summary>
        /// Initializes a new instance of the <see cref="DRForm"/> class.
        /// </summary>
        public InwardRequestForm()
        {
        }
        ...
        public InwardRequestForm(bool setSections)
        {
            if (setSections)
            {
                this.ApprovalMatrixListName = MaterialTrackingListNames.INWARDAPPAPPROVALMATRIX;
                this.SectionsList = new List<ISection>();
                this.SectionsList.Add(new Recipient1Section(true));  ////LEVEL 0
                this.SectionsList.Add(new Recipient2Section(true));        ////LEVEL 1
                this.SectionsList.Add(new ApplicationStatusSection(true) { SectionName = SectionNameConstant.APPLICATIONSTATUS });
                this.SectionsList.Add(new ActivityLogSection(MaterialTrackingListNames.INWARDACTIVITYLOG));
                this.Buttons = new List<Button>();
                this.MainListName = MaterialTrackingListNames.INWARDLIST;
            }
        }
        ...
        {
            get { return FormNames.INWARDREQUESTFORM; }
        }
