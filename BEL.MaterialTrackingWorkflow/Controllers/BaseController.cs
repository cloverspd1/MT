            ...
            get
            {
                if (this.SPCurrentUser == null)
                {
                    if (!this.EnvironmentLive)
                    {
                        ...
                        this.SPCurrentUser.UserId = "31";
                        this.SPCurrentUser = InwardRequestBusinessLayer.Instance.getUSerDetail(Convert.ToInt32(this.SPCurrentUser.UserId));   ///CommonBusinessLayer.Instance.GetLoginUserDetail(this.SPCurrentUser.UserId);
